...
public abstract class NettySrvAcceptor implements SrvAcceptor {
    ...
    //netty的元素初始化
    protected void init(){
    	ThreadFactory bossFactory = new DefaultThreadFactory("com.njxs.netty.acceptor.boss");
        ThreadFactory workerFactory = new DefaultThreadFactory("com.njxs.netty.acceptor.worker");
    ...
    public void start(boolean sync) throws InterruptedException {
        ...
        logger.info("com.njxs.netty acceptor server start");
